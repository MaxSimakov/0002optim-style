...
! function(B, e) {
    ...
    var a, l, S = e.document,
        ...
        M = function(e) { return !isNaN(parseFloat(e)) && isFinite(e) },
        A = function(e) { return e.stopPropagation() },
        D = function(n, a, l) { return function(e) { n && e.preventDefault(), a && e.stopPropagation(), "function" == typeof l && l() } },
    ...
    B.fn.extend({
        hcOffcanvasNav: function(e) {
            ...
            var l, x = B.extend({}, { maxWidth: 1024, pushContent: !1, side: "left", levelOpen: "overlap", levelSpacing: 40, levelTitles: !1, navTitle: null, navClass: "", disableBody: !0, closeOnClick: !0, customToggle: null, insertClose: !0, insertBack: !0, labelClose: "", labelBack: "Назад" }, e),
            ...
            return this.each(function() {
                ...
                if (a.length) {
                    ...
                    if (x.navTitle && h.children().prepend("<h2>" + x.navTitle + "</h2>"), n.on("click", A).removeAttr("id").removeClass().addClass("\n            hc-offcanvas-nav\n            " + p + "\n            " + (x.navClass || "") + "\n            nav-levels-" + (x.levelOpen || "none") + "\n            side-" + x.side + "\n            " + (x.disableBody ? "disable-body" : "") + "\n            " + (N ? "is-ios" : "") + "\n            " + (P ? "touch-device" : "") + "\n          ").find("[id]").removeAttr("id"), setTimeout(function() {
                            var e;
                            s = h.width(), e = h.css("transition-duration"), o = parseFloat(e) * (/\ds$/.test(e) ? 1e3 : 1), "boolean" != typeof x.pushContent && (c = B(x.pushContent)).length && E(function e(n) { return "string" == typeof n ? n : n.attr("id") ? "#" + n.attr("id") : n.attr("class") ? n.prop("tagName").toLowerCase() + "." + n.attr("class").replace(/\s+/g, ".") : e(n.parent()) + " " + n.prop("tagName").toLowerCase() }(x.pushContent) + " {\n                transition: " + h.css("transition-property").split(",")[0] + " " + h.css("transition-duration") + " " + h.css("transition-timing-function").split(",")[0] + ";\n              }")
                    ...
                    a.each(function() {
                        ...
                        if (0 !== n) {
                            ...
                            if (v[n][t].checkbox = r, a.prepend(r), l.attr("href") && "#" !== l.attr("href") ? i.append(s) : l.on("click", D(!0, !0)).prepend(s), !1 !== x.insertBack && "overlap" === x.levelOpen) {
                                ...
                                c.children("a").on("click", D(!0, !0, function() { return y(n, t) })), !0 === x.insertBack ? e.prepend(c) : M(x.insertBack) && H(c, x.insertBack, e)
                            }
                        }
                    }), O.append(n);
                    var g = function(e, n) {
                ...
                function m() {
                    ...
                    t.prop("checked") ? (n = i, a = v[e = o][n].checkbox.parent("li"), (l = v[e][n].wrapper).addClass("sub-level-open"), a.addClass("level-open"), "overlap" === x.levelOpen && (l.on("click", function() { return y(e, n) }), T(h, e * x.levelSpacing), c && c.length && T(c, s + e * x.levelSpacing))) : y(o, i)
                }

                function k() { l = !0, n.addClass("nav-open"), r.addClass("toggle-open"), "expand" === x.levelOpen && i && clearTimeout(i), x.disableBody && (t = w.scrollTop() || O.scrollTop(), S.documentElement.scrollHeight > S.documentElement.offsetHeight && w.addClass("hc-nav-yscroll"), O.addClass("hc-nav-open"), t && O.css("top", -t)), c && c.length && T(c, s) }

                function C() { l = !1, c && c.length && T(c, 0), n.removeClass("nav-open"), h.removeAttr("style"), r.removeClass("toggle-open"), !1 !== x.levelOpen && "none" !== x.levelOpen && (i = setTimeout(function() { y(0) }, "expand" === x.levelOpen ? o : 0)), x.disableBody && (O.removeClass("hc-nav-open"), w.removeClass("hc-nav-yscroll"), t && (O.css("top", "").scrollTop(t), w.scrollTop(t), t = 0)) }

                function b(e) { e.preventDefault(), e.stopPropagation(), l ? C() : k() }

                function y(e, n) {
                    for (var a = e; a <= Object.keys(v).length; a++) {
                        if (0 !== a)
                            if (a == e && void 0 !== n) { if (g(a, n), "overlap" === x.levelOpen) v[a][n].wrapper.off("click").on("click", A), T(h, (a - 1) * x.levelSpacing), c && c.length && T(c, s + (a - 1) * x.levelSpacing) } else
                                for (var l in v[a]) { if (g(a, l), "overlap" === x.levelOpen) v[a][l].wrapper.off("click").on("click", A), a == e && (T(h, (a - 1) * x.levelSpacing), c && c.length && T(c, s + (a - 1) * x.levelSpacing)) }
                    }
                }
            })
        }
